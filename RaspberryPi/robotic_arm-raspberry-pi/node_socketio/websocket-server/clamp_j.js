...
var fs = require('fs');
var file_pos_1=__dirname + '/../metadata/position/actuator_clamp.pos';
var valor_test;
var result;
var data1;
var valuefin=0;
...
fs.readFile(__dirname+'/../metadata/position/actuator_clamp.pos', function(err, data) {
       if (err) {
	    console.log(err);
            res.writeHead(500);
...
'                {'+
'                    "type": "OpenSocial gadget",'+
'                    "url": "http://62.204.201.213/German/Raspbery_Pi/node_socketio/robotic_arm/production/xml/clamp_j.xml"'+
'                },'+ 
' 		{'+
...
'            {'+
'                "actuatorId": "clamp",'+
'                "fullName": "clamp_position",'+
'                "description": "Sets the clamp position",'+
'                "webSocketType": "text",'+

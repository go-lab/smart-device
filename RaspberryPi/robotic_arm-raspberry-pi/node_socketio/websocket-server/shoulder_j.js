...
var fs = require('fs');
var file_pos_1=__dirname + '/../metadata/position/actuator_shoulder.pos';
var valor_test;
var result;
var data1;
var valuefin=0;
...
fs.readFile(__dirname+'/../metadata/position/actuator_shoulder.pos', function(err, data) {
       if (err) {
	    console.log(err);
            res.writeHead(500);
...
'                {'+
'                    "type": "OpenSocial gadget",'+
'                    "url": "http://62.204.201.213/German/Raspbery_Pi/node_socketio/robotic_arm/production/xml/shoulder_j.xml"'+
'                },'+ 
' 		{'+
...
'            {'+
'                "actuatorId": "shoulder",'+
'                "fullName": "shoulder_position",'+
'                "description": "Sets the shoulder position",'+
'                "webSocketType": "text",'+

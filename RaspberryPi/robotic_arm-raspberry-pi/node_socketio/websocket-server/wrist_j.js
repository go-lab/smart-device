...
var fs = require('fs');
var file_pos_1=__dirname + '/../metadata/position/actuator_wrist.pos';
var valor_test;
var result;
var data1;
var valuefin=0;
...
fs.readFile(__dirname+'/../metadata/position/actuator_wrist.pos', function(err, data) {
       if (err) {
	    console.log(err);
            res.writeHead(500);
...
'                {'+
'                    "type": "OpenSocial gadget",'+
'                    "url": "http://62.204.201.213/German/Raspbery_Pi/node_socketio/robotic_arm/production/xml/wrist_j.xml"'+
'                },'+ 
' 		{'+
...
'            {'+
'                "actuatorId": "wrist",'+
'                "fullName": "wrist_position",'+
'                "description": "Sets the wrist position",'+
'                "webSocketType": "text",'+
